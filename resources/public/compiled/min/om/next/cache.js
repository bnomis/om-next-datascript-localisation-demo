...
var id_SINGLEQUOTE__22399 = self__.arr.shift();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(self__.index,((function (id_SINGLEQUOTE__22399,this$){
return (function (p1__22398_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__22398_SHARP_,id_SINGLEQUOTE__22399),id,x);
});})(id_SINGLEQUOTE__22399,this$))
);
} else {
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){
return cljs.core._write(writer__6741__auto__,"om.next.cache/Cache");
});
...
return (new om.next.cache.Cache([],(function (){var G__22401 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__22401) : cljs.core.atom.call(null,G__22401));
})(),size));
});
